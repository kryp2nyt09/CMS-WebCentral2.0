...
public partial class _ApprovingAuthorityExportReport : System.Web.UI.Page
{
    ...
    public DataTable GetApprovingAutority
    {
        get
        {
            ...
            if (data == null)
            {
                data = GetApprovingAutorityRecords();
    ...
    public DataTable GetApprovingAutorityRecords()
    {
    ...
    {
        rdPreview.DataSource = GetApprovingAutorityRecords();
    }
