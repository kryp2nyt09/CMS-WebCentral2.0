<%@ Page Title="" Language="C#" MasterPageFile="~/cmsversion.master" AutoEventWireup="true" CodeFile="StatementOfAccountDetails.aspx.cs" Inherits="portal_UserModal_StatementOfAccount_StatementOfAccountDetails" %>
            ...
            <div class="container">
                ...
                <telerik:LayoutColumn HiddenMd="true" HiddenSm="true" HiddenXs="true">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel2" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="gridwrapper">
                        ...
                        <br />
                        <h5>PAYMENTS</h5>
                        <telerik:RadGrid ID="PaymentGrid"
                            runat="server"
                            AllowFilteringByColumn="true"
                            PageSize="10" Skin="Glow" AllowSorting="true"
                            CommandItemDisplay="Top"
                            ...
                            <MasterTableView NoMasterRecordsText ="No Payment Records" AutoGenerateColumns="False"
                                AllowFilteringByColumn="false">
                        ...
                        <telerik:RadGrid ID="AdjustmentGrid"
                            ...
                            <MasterTableView NoMasterRecordsText ="No Adjustments Records" AutoGenerateColumns="False"
                                AllowFilteringByColumn="false">
