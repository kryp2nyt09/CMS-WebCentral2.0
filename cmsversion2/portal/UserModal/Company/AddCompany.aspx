                                    ...
                                    <div class="col-xs-12">
                                        <div class="col-xs-6">
                                            <div class="col-xs-3">
                                                ...
                                                <br />
                                                <br />
                                                <asp:Label ID="Label47" runat="server" Text="Payment Mode"></asp:Label>
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <div class="col-xs-3">
                                                ...
                                                <br />
                                                <br />
                                                <telerik:RadComboBox ID="rcbApprovedBy" Width="230px" Height="200px" runat="server"></telerik:RadComboBox>
                                                <br />
                                                <br />
                                                <telerik:RadComboBox ID="rcbBCO" Width="230px" Height="200px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rcbBCO_OnSelectedIndexChanged"></telerik:RadComboBox>
                                                <br />
                                                <br />
                                                <telerik:RadComboBox ID="rcbArea" Width="230px" Height="200px" runat="server"></telerik:RadComboBox>
                                                <br />
                                                <br />
