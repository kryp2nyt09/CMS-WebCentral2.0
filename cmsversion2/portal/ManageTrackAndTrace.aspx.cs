...
public partial class _ManageTrackAndTrace : System.Web.UI.Page
{
    ...
    protected void btnBA_Batch_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_BA_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/AddBatch.aspx?ID=" + batchid + "&batchCode=" + batchCode;
    ...
    protected void btnBA_Batch_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (batchid != "")
        {
            ...
            rwEdit_BA_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/EditBatch.aspx?ID=" + batchid;
    ...
    protected void btnBA_Remarks_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_BA_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/AddRemarks.aspx?ID=" + remarksid + "&remarkCode=" + remarkCode;
    ...
    protected void btnBA_Remarks_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (remarkId != "")
        {
            ...
            rwEdit_BA_Remarks.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/EditRemarks.aspx?ID=" + remarkId;
    ...
    protected void btnGT_Batch_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_GT_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/AddBatch.aspx?ID=" + batchid + "&batchCode=" + batchCode;
    ...
    protected void btnGT_Batch_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (batchid != "")
        {
            ...
            rwEdit_GT_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/EditBatch.aspx?ID=" + batchid;
    ...
    protected void btnGT_Airlines_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_GT_Airlines.NavigateUrl = "http://" + host + "/portal/UserModal/Airlines/AddAirlines.aspx?ID=" + airlineid + "&airlineCode=" + airlineCode;
    ...
    protected void btnGT_Airlines_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (airlineid != "")
        {
            ...
            rwEdit_GT_Airlines.NavigateUrl = "http://" + host + "/portal/UserModal/Airlines/EditAirlines.aspx?ID=" + airlineid;
    ...
    protected void btnGO_Batch_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_GO_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/AddBatch.aspx?ID=" + batchid + "&batchCode=" + batchCode;
    ...
    protected void btnGO_Batch_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (batchid != "")
        {
            ...
            rwEdit_GO_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/EditBatch.aspx?ID=" + batchid;
    ...
    protected void btnGO_Remarks_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_GO_Remarks.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/AddRemarks.aspx?ID=" + remarksid + "&remarkCode=" + remarkCode;
    ...
    protected void btnGO_Remarks_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (remarkId != "")
        {
            ...
            rwEdit_GO_Remarks.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/EditRemarks.aspx?ID=" + remarkId;
    ...
    protected void btnGO_Airlines_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_GO_Airlines.NavigateUrl = "http://" + host + "/portal/UserModal/Airlines/AddAirlines.aspx?ID=" + airlineid + "&airlineCode=" + airlineCode;
    ...
    protected void btnGO_Airlines_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (airlineid != "")
        {
            ...
            rwEdit_GO_Airlines.NavigateUrl = "http://" + host + "/portal/UserModal/Airlines/EditAirlines.aspx?ID=" + airlineid;
    ...
    protected void btnGI_Remarks_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (remarkId != "")
        {
            ...
            rwEdit_GI_Remarks.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/EditRemarks.aspx?ID=" + remarkId;
    ...
    protected void btnCT_Batch_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_CT_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/AddBatch.aspx?ID=" + batchid + "&batchCode=" + batchCode;
    ...
    protected void btnCT_Batch_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (batchid != "")
        {
            ...
            rwEdit_CT_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/EditBatch.aspx?ID=" + batchid;
    ...
    protected void btnCT_Airlines_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_CT_Airlines.NavigateUrl = "http://" + host + "/portal/UserModal/Airlines/AddAirlines.aspx?ID=" + airlineid + "&airlineCode=" + airlineCode;
    ...
    protected void btnCT_Airlines_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (airlineid != "")
        {
            ...
            rwEdit_CT_Airlines.NavigateUrl = "http://" + host + "/portal/UserModal/Airlines/EditAirlines.aspx?ID=" + airlineid;
    ...
    protected void btnCT_Status_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_CT_Status.NavigateUrl = "http://" + host + "/portal/UserModal/Status/AddStatus.aspx?ID=" + statusId + "&statusCode=" + statusCode;
    ...
    protected void btnCT_Reason_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (reasonId != "")
        {
            ...
            rwEdit_CT_Reason.NavigateUrl = "http://" + host + "/portal/UserModal/Reason/EditReason.aspx?ID=" + reasonId + "&StatusCode=" + statusCode;
    ...
    protected void btnSG_Batch_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_SG_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/AddBatch.aspx?ID=" + batchid + "&batchCode=" + batchCode;
    ...
    protected void btnSG_Batch_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (batchid != "")
        {
            ...
            rwEdit_SG_Batch.NavigateUrl = "http://" + host + "/portal/UserModal/Batch/EditBatch.aspx?ID=" + batchid;
    ...
    protected void btnSG_Remarks_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_SG_Remarks.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/AddRemarks.aspx?ID=" + remarksid + "&remarkCode=" + remarkCode;
    ...
    protected void btnSG_Remarks_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (remarkId != "")
        {
            ...
            rwEdit_SG_Remarks.NavigateUrl = "http://" + host + "/portal/UserModal/Remarks/EditRemarks.aspx?ID=" + remarkId;
    ...
    protected void btnHC_Status_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_HC_Status.NavigateUrl = "http://" + host + "/portal/UserModal/Status/AddStatus.aspx?ID=" + statusId + "&statusCode=" + statusCode;
    ...
    protected void btnHC_Status_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (statusId != "")
        {
            ...
            rwEdit_HC_Status.NavigateUrl = "http://" + host + "/portal/UserModal/Status/EditStatus.aspx?ID=" + statusId;
    ...
    protected void btnHC_Reason_Add_Click(object sender, EventArgs e)
    {
        ...
        rwAdd_HC_Reason.NavigateUrl = "http://" + host + "/portal/UserModal/Reason/AddReason.aspx?ID=" + reasonId + "&StatusCode=" + statusCode;
    ...
    protected void btnHC_Reason_Edit_Click(object sender, EventArgs e)
    {
        ...
        if (reasonId != "")
        {
            ...
            rwEdit_HC_Reason.NavigateUrl = "http://" + host + "/portal/UserModal/Reason/EditReason.aspx?ID=" + reasonId + "&StatusCode=" + statusCode;
