<%@ Page Language="C#" Title="Hold" MasterPageFile="~/cmsversion.master" AutoEventWireup="true" CodeFile="CargoMonitoringHold.aspx.cs" Inherits="portal_Operation_CargoTransfer_CargoMonitoringHold" %>
...
<asp:Content ID="Hold" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
<div class="wrapper">
    <div id="page-wrapper">
        <div class="container">
            <!--- PAGE HEADER--->
